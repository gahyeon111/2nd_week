...
import 'package:battle_reverse/utils/utils.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:provider/provider.dart';
import 'package:socket_io_client/socket_io_client.dart';

import 'package:battle_reverse/screens/colorTheme.dart';
import 'package:battle_reverse/utils/coordinate.dart';
import '../provider/room_data_provider.dart';

class GameMethods {
  // return 0: gameover, 1: nothing, 2: turnpassed
  int checkWinner(BuildContext context, Socket socketClent) {
    ...
    if (winner != 0) {
      ...
      score += roomDataProvider.player1.playerType == ITEM_WHITE
  ...
  bool pasteItemToTable(int row, int col, int item, BuildContext context) {
    ...
    if ((table[row][col].value == ITEM_EMPTY)||(table[row][col].value == HINT)) {
      ...
      if (listCoordinate.isNotEmpty) {
        ...
        currentTurn = inverseItem(currentTurn);
        int n = makeHint(roomDataProvider.roomData['turn']['playerType'], context);
